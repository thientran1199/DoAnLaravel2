        ...
        <li class="nav-item">
            ...
            <div id="orderdetail" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('order_detail.index') }}">Danh sách</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{ url('admin/img/biti.jpg') }}">
              </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
       <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="{{ route('logout') }}" onclick="return confirm('Bạn có muốn thoát không?')">Logout</a>
        </div>
      </div>
    </div>
  </div>
